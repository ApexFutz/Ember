                  ...
                  return (
                    ...
                    >
                      <div style={{
                        ...
                        <p style={{ ...styles.bubbleText, color: isMine ? '#fff' : '#1a1714' }}>{msg.content}</p>
                        <span style={{
                          ...styles.bubbleTime,
                          color: isMine ? 'rgba(255,255,255,0.6)' : '#8a837a',
                        }}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: '24px', fontWeight: '500', color: '#1a1714', margin: '0 0 20px' },
  container: {
    display: 'flex',
  ...
  noThreads: { padding: '24px', fontSize: '13px', color: '#8a837a', textAlign: 'center' },
  threadItem: {
    display: 'flex',
    gap: '12px',
    padding: '14px 16px',
  ...
  threadItemActive: { backgroundColor: '#faf8f5' },
  threadAvatar: {
    width: '40px',
    height: '40px',
    borderRadius: '50%',
  ...
  threadAvatarInitial: { fontSize: '15px', fontWeight: '500', color: '#fff' },
  ...
  threadName: { fontSize: '14px', fontWeight: '500', color: '#1a1714' },
  threadUnread: {
    backgroundColor: '#c8943a',
    color: '#fff',
    fontSize: '11px',
  ...
  threadRole: { fontSize: '12px', color: '#8a837a' },
  threadPreview: {
    fontSize: '12px',
    color: '#8a837a',
    overflow: 'hidden',
  ...
  headerName: { fontSize: '14px', fontWeight: '500', color: '#1a1714', margin: 0 },
  headerRole: { fontSize: '12px', color: '#8a837a', margin: 0 },
  messageList: {
    flex: 1,
    overflowY: 'auto',
    padding: '20px',
