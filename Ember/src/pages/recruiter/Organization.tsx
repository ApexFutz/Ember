...
const styles: Record<string, React.CSSProperties> = {
  ...
  roleBadge: { fontSize: '11px', fontWeight: 600, padding: '4px 10px', borderRadius: '999px', textTransform: 'capitalize', color: 'var(--color-primary-light)', background: 'var(--color-primary-soft)', border: '1px solid var(--color-primary-soft-border)' },
  ...
  btnPrimary: { padding: '9px 16px', backgroundColor: 'var(--color-primary)', color: 'var(--color-on-primary)', border: 'none', borderRadius: 'var(--radius-md)', fontSize: '13px', fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap' },
  ...
  btnDanger: { padding: '9px 14px', background: 'transparent', border: '1px solid var(--color-error-soft)', borderRadius: 'var(--radius-md)', fontSize: '13px', fontWeight: 500, color: 'var(--color-error)', cursor: 'pointer', whiteSpace: 'nowrap' },
}
